...
def validate_type_argument(func):
    ...
    def wrapper(*args, **kwargs):
        # print('func.__annotations__', func.__annotations__)
        for name_argument, type_argument in func.__annotations__.items():
            if not isinstance(kwargs[name_argument], type_argument):
